...
# --- START: Inject the connection URL ---
# This line overrides the empty 'sqlalchemy.url' setting from alembic.ini
config.set_main_option("sqlalchemy.url", POSTGRES_URI)
# --- END: Inject the connection URL ---

# for 'autogenerate' support
# Import all tables so they register with metadata
